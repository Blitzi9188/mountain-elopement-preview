...
def build_proposal_guide(lang):
    ...
    C.append(p("Golden hour in the evening works too, and is kinder to non-morning people &mdash; but it is busier, so we choose the spot more carefully. Exact sunrise and sunset times swing by nearly three hours across the year, so the plan always starts with your date. <!-- FAKT PRÜFEN: exakte Sonnenaufgangs-/Sonnenuntergangszeiten je Monat pro Datum bestätigen -->","Auch die goldene Stunde am Abend funktioniert und ist freundlicher zu Morgenmuffeln &mdash; aber es ist voller, also wählen wir den Ort sorgfältiger. Die genauen Sonnenauf- und -untergangszeiten schwanken übers Jahr um fast drei Stunden, deshalb beginnt der Plan immer mit eurem Datum. <!-- FAKT PRÜFEN: exakte Sonnenaufgangs-/Sonnenuntergangszeiten je Monat pro Datum bestätigen -->"))
