...
def build_helicopter_guide(lang):
    ...
    C.append(fig('h20-heli-flying.webp',"A helicopter over the Dolomite peaks at golden hour","Ein Helikopter über den Dolomitengipfeln in der goldenen Stunde"))
    ...
    C.append(fig('h09-rings.webp',"Exchanging rings on the mountain after the flight","Der Ringtausch am Berg nach dem Flug"))
    ...
    C.append(fig('h02-cockpit.webp',"View across the cockpit as the helicopter climbs over the valley","Blick durchs Cockpit, während der Helikopter über das Tal steigt"))
    ...
    C.append(fig('h05-aerial-ridge.webp',"A sharp ridge line seen from above during the flight","Ein scharfer Grat von oben während des Flugs"))
    ...
    C.append(fig('h14-enrosadira.webp',"The Dolomite walls glowing pink at last light behind the couple","Die Dolomitenwände glühen im letzten Licht rosa hinter dem Paar"))
    C.append(fig('h15-sunset-peaks.webp',"Silhouetted peaks against a warm sunset sky","Gipfelsilhouetten vor warmem Abendhimmel"))
    ...
    C.append(fig('h04-aerial-peak.webp',"An aerial view of a jagged Dolomite peak from the helicopter","Luftaufnahme eines schroffen Dolomitengipfels aus dem Helikopter"))
    C.append(fig('h06-landed-couple.webp',"The couple stepping out onto the mountain beside the landed helicopter","Das Paar steigt am Berg neben dem gelandeten Helikopter aus"))
    ...
    C.append(fig('h03-window-peaks.webp',"The Dolomite peaks seen from the helicopter window","Die Dolomitengipfel aus dem Helikopterfenster"))
    ...
    C.append(fig('h17-aerial-cloud.webp',"A peak breaking through cloud, seen from the air","Ein Gipfel durchbricht die Wolken, aus der Luft gesehen"))
    ...
    C.append(fig('h11-ridge-couple.webp',"The couple on a wind-scoured ridge, dress moving in the breeze","Das Paar auf einem windgefegten Grat, das Kleid im Wind"))
    C.append(fig('h10-summit-portrait.webp',"A portrait on the summit with the Dolomites behind","Ein Porträt am Gipfel, die Dolomiten im Rücken"))
    ...
    C.append(fig('h08-vows.webp',"Exchanging vows on the summit, the range spread below","Das Ja-Wort am Gipfel, das Massiv darunter ausgebreitet"))
    ...
    C.append(fig('h13-ridge-wide.webp',"The couple alone on a summit ridge with nobody else in sight","Das Paar allein auf einem Gipfelgrat, niemand sonst in Sicht"))
    ...
    C.append(fig('h16-panorama-couple.webp',"The couple taking in the panorama after the ceremony","Das Paar genießt das Panorama nach der Zeremonie"))
    ...
    C.append(fig('h12-ridge-walk.webp',"The couple walking a quiet ridge after landing","Das Paar geht nach der Landung einen stillen Grat entlang"))
    ...
    faq_html+=''.join('<div style="margin:1.3em 0 0;border-top:1px solid var(--line);padding-top:1.1em">'
      f'<h3 style="font-family:var(--serif);font-weight:400;font-size:20px;margin:0 0 .3em">{(qde if DE else qen)}</h3>'
      f'<p style="color:var(--ink-2);margin:0">{(ade if DE else aen)}</p></div>' for qen,aen,qde,ade in HELI_FAQ)
    faq_ld={"@context":"https://schema.org","@type":"FAQPage","mainEntity":[
      {"@type":"Question","name":_plain(qde if DE else qen),"acceptedAnswer":{"@type":"Answer","text":_plain(ade if DE else aen)}} for qen,aen,qde,ade in HELI_FAQ]}
    related=''.join(story_card(lang,P,STORYBY[sl]) for sl in ex['stories'])
