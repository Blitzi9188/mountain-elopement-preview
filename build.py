...
T = {
 ...
 'tp_fp1':{'en':'We&rsquo;re a small team, at home in the Dolomites and the Alps &mdash; planner Jlenia and photographer Andreas. But calling us a team doesn&rsquo;t quite cover it. We&rsquo;re closest friends first. Our families spend weekends together; our kids grow up alongside each other. What brought us here wasn&rsquo;t a business plan &mdash; it was a shared obsession with the mountains and with what happens when two people say yes somewhere quiet and vast.',
           'de':'Wir sind ein kleines Team, zu Hause in den Dolomiten und den Alpen &mdash; Planerin Jlenia und Fotograf Andreas. Aber &bdquo;Team&ldquo; trifft es nicht ganz. Wir sind zuerst engste Freunde. Unsere Familien verbringen Wochenenden miteinander; unsere Kinder wachsen zusammen auf. Was uns hierher gebracht hat, war kein Businessplan &mdash; es war die gemeinsame Leidenschaft für die Berge und für das, was passiert, wenn zwei Menschen an einem stillen, weiten Ort Ja sagen.',
           'es':'Somos un equipo pequeño, en casa en los Dolomitas y los Alpes &mdash; la planner Jlenia y el fotógrafo Andreas. Pero llamarnos equipo se queda corto. Antes que nada somos amigos íntimos. Nuestras familias pasan los fines de semana juntas; nuestros hijos crecen codo con codo. Lo que nos trajo aquí no fue un plan de negocio &mdash; fue una obsesión compartida por la montaña y por lo que ocurre cuando dos personas se dan el sí en un lugar tranquilo e inmenso.'},
 'tp_fp2':{'en':'That&rsquo;s the difference you feel on the day. When the people planning and photographing your elopement actually like each other &mdash; trust each other, read each other without a word &mdash; the day runs softer. No friction, no awkward hand-offs, no team that met that morning. Just two people who&rsquo;ve done this together for years, moving as one.',
           'de':'Genau das spürt man am Tag selbst. Wenn die Menschen, die euer Elopement planen und fotografieren, einander wirklich mögen &mdash; einander vertrauen, sich ohne Worte verstehen &mdash;, läuft der Tag weicher. Keine Reibung, keine holprigen Übergaben, kein Team, das sich erst an dem Morgen kennengelernt hat. Nur zwei Menschen, die das seit Jahren gemeinsam tun und wie eine Einheit arbeiten.',
           'es':'Esa es la diferencia que se siente el día de la boda. Cuando quienes planifican y fotografían vuestro elopement se aprecian de verdad &mdash; confían el uno en el otro, se leen sin una palabra &mdash;, el día fluye más suave. Sin fricciones, sin relevos incómodos, sin un equipo que se conoció esa mañana. Solo dos personas que llevan años haciendo esto juntas, moviéndose como una sola.'},
 'tp_fp3':{'en':'For as long as we can remember, the mountains have been where we feel most ourselves. Still summits before the first hikers arrive. Hidden lakes that hold the light for twelve minutes at dawn. We know these places not from a location list, but because we&rsquo;ve stood there, season after season, in every kind of weather. We bring couples to them &mdash; and we capture the day exactly as it feels: unposed, unhurried, real.',
           'de':'Solange wir denken können, sind die Berge der Ort, an dem wir ganz wir selbst sind. Stille Gipfel, bevor die ersten Wanderer kommen. Versteckte Seen, die im Morgengrauen zwölf Minuten lang das Licht halten. Wir kennen diese Orte nicht aus einer Location-Liste, sondern weil wir dort standen &mdash; Saison für Saison, bei jedem Wetter. Wir bringen Paare dorthin &mdash; und halten den Tag genau so fest, wie er sich anfühlt: ungestellt, ohne Hast, echt.',
           'es':'Desde que tenemos memoria, la montaña es donde más nosotros mismos nos sentimos. Cumbres en calma antes de que lleguen los primeros excursionistas. Lagos escondidos que sostienen la luz doce minutos al amanecer. Conocemos estos lugares no por una lista de localizaciones, sino porque hemos estado allí, temporada tras temporada, con todo tipo de clima. Llevamos a las parejas hasta ellos &mdash; y capturamos el día exactamente como se siente: sin poses, sin prisa, real.'},
 'tp_fp4':{'en':'We plan and photograph your whole day, start to finish. And where it makes your day even better, we bring in a trusted circle &mdash; florals, film, ceremony, cake &mdash; people we&rsquo;ve worked beside for years and would trust with our own. But you only ever deal with us. One team. One point of contact. Two friends who happen to be very good at this.',
           'de':'Wir planen und fotografieren euren ganzen Tag, von Anfang bis Ende. Und wo es euren Tag noch schöner macht, holen wir einen vertrauten Kreis dazu &mdash; Blumen, Film, Zeremonie, Torte &mdash; Menschen, mit denen wir seit Jahren zusammenarbeiten und denen wir blind vertrauen. Aber ihr habt immer nur mit uns zu tun. Ein Team. Eine Ansprechstelle. Zwei Freunde, die zufällig richtig gut darin sind.',
           'es':'Planificamos y fotografiamos todo vuestro día, de principio a fin. Y donde hace vuestro día aún mejor, sumamos un círculo de confianza &mdash; flores, film, ceremonia, tarta &mdash; personas con las que trabajamos desde hace años y en las que confiaríamos como en nosotros mismos. Pero siempre tratáis solo con nosotros. Un equipo. Un único punto de contacto. Dos amigos a los que se les da muy bien esto.'},
...
IT={
 ...
 'tp_fp1':'Siamo un piccolo team, a casa nelle Dolomiti e nelle Alpi &mdash; la planner Jlenia e il fotografo Andreas. Ma chiamarci team non basta. Prima di tutto siamo amici del cuore. Le nostre famiglie passano i weekend insieme; i nostri figli crescono fianco a fianco. Ciò che ci ha portati qui non è stato un business plan &mdash; è stata un&rsquo;ossessione condivisa per la montagna e per ciò che accade quando due persone si dicono sì in un luogo silenzioso e sconfinato.',
 'tp_fp2':'È questa la differenza che si sente nel giorno. Quando chi pianifica e fotografa il vostro elopement si piace davvero &mdash; si fida, si legge senza una parola &mdash;, la giornata scorre più morbida. Nessun attrito, nessun passaggio di consegne goffo, nessun team conosciuto quella mattina. Solo due persone che lo fanno insieme da anni, muovendosi come una sola.',
 'tp_fp3':'Da che ci ricordiamo, la montagna è il luogo in cui ci sentiamo più noi stessi. Vette silenziose prima che arrivino i primi escursionisti. Laghi nascosti che trattengono la luce per dodici minuti all&rsquo;alba. Conosciamo questi luoghi non da un elenco di location, ma perché ci siamo stati, stagione dopo stagione, con ogni tempo. Ci portiamo le coppie &mdash; e raccontiamo la giornata esattamente come si sente: senza pose, senza fretta, autentica.',
 'tp_fp4':'Pianifichiamo e fotografiamo l&rsquo;intera vostra giornata, dall&rsquo;inizio alla fine. E dove rende la giornata ancora più bella, coinvolgiamo una cerchia fidata &mdash; fiori, film, cerimonia, torta &mdash; persone con cui lavoriamo da anni e di cui ci fidiamo come di noi stessi. Ma avete a che fare sempre e solo con noi. Un team. Un unico punto di contatto. Due amici che, guarda caso, sono molto bravi in questo.',
...
def build_team(lang):
    ...
    body=(nav(lang,rel,'team')+
      ...
      f'<p class="lead">{t(lang,"tp_flead")}</p><p class="dropcap">{t(lang,"tp_fp1")}</p><p>{t(lang,"tp_fp2")}</p><p>{t(lang,"tp_fp3")}</p><p>{t(lang,"tp_fp4")}</p>'
