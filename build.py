...
GUIDES = [
 ...
 {'slug':'most-beautiful-dolomites-spots','img':'s17',
 ...
 {'slug':'mountain-proposal-guide','img':'s03',
 ...
 {'slug':'sunrise-or-sunset-elopement','img':'s02',
 ...
 {'slug':'elopement-things-nobody-tells-you','img':'s10',
...
PI_TEXT={
 'a-journey-of-love-and-adventure':{
  'lead':{'en':'An elopement built like an expedition &mdash; boots laced before dawn, vows earned one switchback at a time.','de':'Ein Elopement wie eine Expedition &mdash; Schuhe geschnürt vor Sonnenaufgang, das Ja mit jeder Kehre verdient.','es':'Un elopement como una expedición &mdash; botas atadas antes del alba, un sí ganado curva a curva.','it':'Un elopement come una spedizione &mdash; scarponi allacciati prima dell&rsquo;alba, un sì conquistato tornante dopo tornante.'},
  'p1':{'en':'Some couples don&rsquo;t want a venue; they want a journey. This day began at the trailhead and climbed with the sun, trading crowds and schedules for ridgelines, wind and the simple company of each other.','de':'Manche Paare wollen keine Location, sondern eine Reise. Dieser Tag begann am Wanderstart und stieg mit der Sonne &mdash; statt Menschenmengen und Zeitplan gab es Grate, Wind und einfach euch beide.','es':'Algunas parejas no quieren un lugar, sino un viaje. Este día empezó en el inicio del sendero y subió con el sol, cambiando multitudes y horarios por crestas, viento y la sencilla compañía del otro.','it':'Alcune coppie non cercano una location, ma un viaggio. Questa giornata è iniziata all&rsquo;imbocco del sentiero ed è salita con il sole, scambiando folla e orari con creste, vento e la semplice compagnia dell&rsquo;altro.'},
  'p2':{'en':'We kept the pace unhurried and the plan loose, letting the mountain set the rhythm. What you see here is the whole arc &mdash; the walk up, the quiet promise at the top, and the golden descent home.','de':'Wir hielten das Tempo ruhig und den Plan offen und ließen den Berg den Rhythmus vorgeben. Was ihr hier seht, ist der ganze Bogen &mdash; der Aufstieg, das stille Versprechen oben und der goldene Abstieg.','es':'Mantuvimos el ritmo tranquilo y el plan abierto, dejando que la montaña marcara el compás. Aquí veis el arco completo &mdash; la subida, la promesa silenciosa en la cima y el descenso dorado.','it':'Abbiamo tenuto un ritmo lento e un piano aperto, lasciando che fosse la montagna a dettare il tempo. Qui vedete l&rsquo;intero arco &mdash; la salita, la promessa silenziosa in vetta e la discesa dorata.'},
  'quote':{'en':'The best days are the ones you have to walk toward.','de':'Die schönsten Tage sind die, zu denen man hinaufsteigen muss.','es':'Los mejores días son los que hay que caminar para alcanzar.','it':'I giorni più belli sono quelli che si raggiungono camminando.'}},
 ...
 'hiking-elopement-lagazuoi-dolomites':{
  'lead':{'en':'Lagazuoi &mdash; a cable car, a mountain refuge at 2,750&thinsp;m, and a balcony over half the Dolomites.','de':'Lagazuoi &mdash; eine Seilbahn, eine Berghütte auf 2.750&thinsp;m und ein Balkon über den halben Dolomiten.','es':'Lagazuoi &mdash; un teleférico, un refugio a 2.750&thinsp;m y un balcón sobre medio Dolomitas.','it':'Lagazuoi &mdash; una funivia, un rifugio a 2.750&thinsp;m e un balcone su mezze Dolomiti.'},
  'p1':{'en':'From the Falzarego Pass a cable car climbs to the Rifugio Lagazuoi, where the terrace looks straight across to the Tofane and the Marmolada. The peak still carries its First World War tunnels; today it carries couples who want the biggest view for the smallest wedding.','de':'Vom Falzarego-Pass steigt eine Seilbahn zur Rifugio Lagazuoi, deren Terrasse direkt zu Tofane und Marmolada blickt. Der Gipfel trägt noch seine Tunnel aus dem Ersten Weltkrieg &mdash; heute trägt er Paare, die für die kleinste Hochzeit die größte Aussicht wollen.','es':'Desde el paso Falzarego un teleférico sube al Rifugio Lagazuoi, cuya terraza mira de frente a las Tofane y la Marmolada. La cima aún conserva sus túneles de la Primera Guerra Mundial; hoy acoge a parejas que quieren la vista más grande para la boda más pequeña.','it':'Dal Passo Falzarego una funivia sale al Rifugio Lagazuoi, la cui terrazza guarda dritto verso le Tofane e la Marmolada. La cima porta ancora le sue gallerie della Grande Guerra; oggi porta coppie che vogliono il panorama più grande per le nozze più piccole.'},
  'p2':{'en':'You can arrive on foot or by cable car, sleep at the refuge, and wake above the clouds for first light. It is adventure with a warm bed at the end of it.','de':'Ihr könnt zu Fuß oder per Seilbahn kommen, in der Hütte übernachten und über den Wolken zum ersten Licht erwachen. Abenteuer &mdash; mit einem warmen Bett am Ende.','es':'Podéis llegar a pie o en teleférico, dormir en el refugio y despertar sobre las nubes con la primera luz. Aventura &mdash; con una cama caliente al final.','it':'Potete arrivare a piedi o in funivia, dormire al rifugio e svegliarvi sopra le nuvole con la prima luce. Avventura &mdash; con un letto caldo alla fine.'},
  'quote':{'en':'A whole range for a witness, and a warm hut for the night.','de':'Ein ganzes Massiv als Zeuge und eine warme Hütte für die Nacht.','es':'Toda una cordillera por testigo y un refugio cálido para la noche.','it':'Un&rsquo;intera catena come testimone e un rifugio caldo per la notte.'}},
