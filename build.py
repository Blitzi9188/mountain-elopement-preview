...
def build_guides(lang):
    for g in GUIDES:
        if g['slug']=='helicopter-elopement-dolomites-guide':
            continue   # rendered by build_helicopter_guide (rich version)
...
for lang in LANGS:
    ...
    build_thankyou(lang); build_guides(lang); build_helicopter_guide(lang); build_region(lang)
